    ...
    addAction () {
      this.$refs['addActionForm'].validate((valid) => {
        if (valid) {
          ...
          let startDate = new Date(this.timelineInfo.actionList[0].expectedTime)
          let endDate = new Date(this.timelineInfo.actionList[this.timelineInfo.actionList.length - 1].expectedTime)
